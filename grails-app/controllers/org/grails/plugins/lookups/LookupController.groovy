...
class LookupController {
    ...
    def list = {
        if (!loaded) {
            if (lookupService.hasPlugin("localizations")) {
                ...
                if (test == "_missing!") {
                    ...
                    loc.loadPluginData("lookups")
                    loc.loadPluginData("lookupValues")
                }
            }
        ...
        [lookupList: lst, hasDrilldowns: lookupService.hasPlugin("drilldowns")]
    }
    ...
    def show = {
        ...
        else { return [lookup: lookup, hasDrilldowns: lookupService.hasPlugin("drilldowns")] }
    }
    ...
    // just for testing - forward to a view that will test the client taglibs
