...
<div class="nav">
    ...
    <g:if test="${!hasDrilldowns}">
        <span class="menuButton"><g:link class="create" controller="lookupValue" action="create"><g:message code="lookupValue.new" default="New Lookup Value"/></g:link></span>
    </g:if>
</div>
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value"><img src="${g.lookupResource(dir: 'images', file: lookup.internationalize.toString() + '.png')}" border="0"/></td>
            ...
            <g:if test="${!lookup.values.isEmpty()}">
                <tr>
                    <td>
                        <ul>
                            <g:each in="${lookup.values}" status="i" var="lv">
                                <li>${lv.id}:${lv.value}</li>
                            </g:each>
                        </ul>
                    </td>
                </tr>
