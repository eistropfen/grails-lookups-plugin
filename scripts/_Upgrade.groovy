...
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/lookups.properties", todir:"${basedir}/grails-app/i18n")
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/lookupValues.properties", todir:"${basedir}/grails-app/i18n")
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/lookups.properties", todir:"${basedir}/grails-app/i18n")
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/lookupValues.properties", todir:"${basedir}/grails-app/i18n")
